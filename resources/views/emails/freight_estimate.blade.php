...
<head>
    ...
    <style>
        ...
        .header { background: #16324a; color: white; padding: 15px; text-align: center; font-size: 20px; font-weight: bold; border-radius: 8px 8px 0 0; }
        .content { margin-top: 20px; font-size: 14px; line-height: 1.5; }
        .footer { background: #16324a; color: white; text-align: center; padding: 15px; border-radius: 0 0 8px 8px; margin-top: 20px; font-size: 12px; }
